...
<xml xmlns="https://developers.google.com/blockly/xml" id="toolbox" style="display: none">
  ...
  <sep></sep>
  <category name="Arduino - 基本（無料）" colour="#9C27B0">
  ...
  <category name="Arduino - 拡張（無料）" colour="#673AB7">
    <label text="アナログIO"></label>
  ...
  <category name="🤖 OTTO 2足歩行（無料）" colour="#FF6B35">
    ...
    <sep></sep>
    <label text="ダンス"></label>
    <block type="otto_dance"></block>
    <block type="otto_swing"></block>
    <block type="otto_moonwalk"></block>
    <block type="otto_crusaito"></block>
    <block type="otto_flapping"></block>
    <block type="otto_tiptoe_swing"></block>
    <block type="otto_jitter"></block>
    <block type="otto_updown"></block>
    <block type="otto_ascending_turn"></block>
    <block type="otto_shake_leg"></block>
    <block type="otto_bend"></block>
    <sep></sep>
    <label text="ジェスチャー（感情表現）"></label>
    <block type="otto_gesture"></block>
    <sep></sep>
    <label text="サウンド"></label>
    <block type="otto_sound"></block>
  </category>
  ...
  <category name="📡 センサー（無料）" colour="#FF9800">
    ...
    <sep gap="32"></sep>
    <label text="タッチセンサー"></label>
    <block type="touch_init"></block>
    <block type="touch_read"></block>
    <block type="touch_value"></block>
    <sep gap="32"></sep>
    <label text="サウンドセンサー（マイク）"></label>
    <block type="sound_init"></block>
    <block type="sound_level"></block>
    <block type="sound_detected"></block>
    <sep gap="32"></sep>
    <label text="光センサー"></label>
    <block type="light_init"></block>
  ...
  <category name="🔒 Arduino - プレミアム" colour="#FFD700">
    <block type="esp32_servo_write">
      <value name="ANGLE">
        <shadow type="math_number">
  ...
  <category name="🏠 MQTT/Home Assistant" colour="#00BCD4">
    <label text="MQTT設定"></label>
