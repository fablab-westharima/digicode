...
Blockly.Blocks['neopixel_init'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField('💡 ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_INIT || 'Initialize NeoPixel Ring'))
        .appendField((Blockly.Msg as any).BLOCKS_NEOPIXEL_PIN || 'Pin')
        .appendField(new Blockly.FieldNumber(pins.neopixelRing, 0, 39), 'PIN')
        .appendField((Blockly.Msg as any).BLOCKS_NEOPIXEL_NUMLED || 'LED Count')
        .appendField(new Blockly.FieldNumber(13, 1, 256), 'NUM_LEDS');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_INITTOOLTIP || 'Initialize NeoPixel ring');
  }
};
...
Blockly.Blocks['neopixel_set_color'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('🎨 ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_SETCOLOR || 'LED'))
        .appendField(new Blockly.FieldNumber(0, 0, 255), 'INDEX')
        .appendField((Blockly.Msg as any).BLOCKS_NEOPIXEL_INDEX || '#');
    ...
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_SETCOLORTOOLTIP || 'Set LED color (0-255)');
  }
};
...
Blockly.Blocks['neopixel_set_all'] = {
  init: function() {
    this.appendValueInput('RED')
        .setCheck('Number')
        .appendField('🌈 ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_SETALL || 'Set All LEDs') + ' R');
    this.appendValueInput('GREEN')
        .setCheck('Number')
        .appendField('G');
    this.appendValueInput('BLUE')
    ...
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_SETALLTOOLTIP || 'Set all LED colors');
  }
};
...
Blockly.Blocks['neopixel_show'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('✨ ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_SHOW || 'Update NeoPixel'));
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_SHOWTOOLTIP || 'Apply color settings to LEDs');
  }
};
...
Blockly.Blocks['neopixel_clear'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('⬛ ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_CLEAR || 'Clear All NeoPixels'));
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_CLEARTOOLTIP || 'Turn off all LEDs');
  }
};
...
Blockly.Blocks['neopixel_brightness'] = {
  init: function() {
    this.appendValueInput('BRIGHTNESS')
        .setCheck('Number')
        .appendField('☀️ ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_BRIGHTNESS || 'NeoPixel Brightness'));
    this.appendDummyInput()
        .appendField('(0-255)');
    ...
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_BRIGHTNESSTOOLTIP || 'Set LED brightness (0-255)');
  }
};
...
Blockly.Blocks['neopixel_rainbow'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('🌈 ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_RAINBOW || 'Rainbow Effect'))
        .appendField(new Blockly.FieldDropdown([
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_SPEEDNORMAL || 'Normal', 'normal'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_SPEEDFAST || 'Fast', 'fast'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_SPEEDSLOW || 'Slow', 'slow']
        ]), 'SPEED');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_RAINBOWTOOLTIP || 'Display rainbow effect');
  }
};
...
Blockly.Blocks['neopixel_bounce'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('⬅️➡️ ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_BOUNCE || 'Bounce Effect'))
        .appendField(new Blockly.FieldDropdown([
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORRED || 'Red', 'ff0000'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORGREEN || 'Green', '00ff00'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORBLUE || 'Blue', '0000ff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORYELLOW || 'Yellow', 'ffff00'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORPURPLE || 'Purple', 'ff00ff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORCYAN || 'Cyan', '00ffff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORWHITE || 'White', 'ffffff']
        ]), 'COLOR')
        .appendField(new Blockly.FieldDropdown([
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_SPEEDNORMAL || 'Normal', 'normal'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_SPEEDFAST || 'Fast', 'fast'],
    ...
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_BOUNCETOOLTIP || 'LED bouncing effect');
  }
};
...
Blockly.Blocks['neopixel_cycle'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('🔄 ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_CYCLE || 'Cycle Effect'))
        .appendField(new Blockly.FieldDropdown([
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORRED || 'Red', 'ff0000'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORGREEN || 'Green', '00ff00'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORBLUE || 'Blue', '0000ff'],
    ...
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_CYCLETOOLTIP || 'LED rotation effect');
  }
};
...
Blockly.Blocks['neopixel_color_simple'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('💡 ' + ((Blockly.Msg as any).BLOCKS_NEOPIXEL_ALLLEDCOLOR || 'All LED Color'))
        .appendField(new Blockly.FieldDropdown([
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORRED || 'Red', 'ff0000'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORORANGE || 'Orange', 'ff8000'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORYELLOW || 'Yellow', 'ffff00'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORLIME || 'Lime', '80ff00'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORGREEN || 'Green', '00ff00'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORCYAN || 'Cyan', '00ffff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORBLUE || 'Blue', '0000ff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORPURPLE || 'Purple', '8000ff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORPINK || 'Pink', 'ff00ff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLORWHITE || 'White', 'ffffff'],
          [(Blockly.Msg as any).BLOCKS_NEOPIXEL_COLOROFF || 'Off', '000000']
        ]), 'COLOR');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_ALLLEDCOLORTOOLTIP || 'Set all LEDs to specified color');
  }
};
...
Blockly.Blocks['neopixel_light_simple'] = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setColour(NEOPIXEL_COLOR);
    this.setTooltip((Blockly.Msg as any).BLOCKS_NEOPIXEL_LIGHTSIMPLETOOLTIP || 'Set specified LED color');
  }
};
