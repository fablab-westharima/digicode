...
const getToolboxCategories = (): Record<string, string> => ({
  ...
  iot_cloud: `
  <category id="iot_cloud" name="${cat('iotCloud')}" colour="#4CAF50">
    <block type="iot_cloud_connect"></block>
    <block type="iot_cloud_publish"></block>
    <block type="iot_cloud_on_message"></block>
    <block type="iot_cloud_received_value"></block>
    <block type="iot_cloud_disconnect"></block>
    <block type="iot_cloud_is_connected"></block>
  </category>`,
  ...
  <category id="sensorEnvironment" name="${cat('sensorEnvironment')}" colour="#4CAF50">
    ...
    <sep></sep>
    <label text="ENV III ユニット (SHT30+QMP6988)"></label>
    <block type="env3_init"></block>
    <block type="env3_read_temperature"></block>
    <block type="env3_read_humidity"></block>
    <block type="env3_read_pressure"></block>
    <sep></sep>
    <label text="ENV IV ユニット (SHT40+BMP280)"></label>
    <block type="env4_init"></block>
  </category>`,
