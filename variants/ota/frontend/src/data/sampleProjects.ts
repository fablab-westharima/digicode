...
<statement name="LOOP">
      ...
      <block type="ha_light_on_command" x="50" y="700">
        <field name="LIGHT_ID">rgb_led</field>
        <statement name="CALLBACK">
          <block type="controls_if">
            <mutation else="1"></mutation>
...
<statement name="LOOP">
  ...
  // ===== Phase 2 C 拡充 (2026-04-26): AI Few-shot 用 残 8 sample =====
  {
    ...
    category: 'robots',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="biped_init"><field name="PIN_LL">27</field><field name="PIN_RL">15</field><field name="PIN_LF">14</field><field name="PIN_RF">13</field></block></statement></block><block type="arduino_loop" x="50" y="250"><statement name="LOOP"><block type="biped_home_blocking"><next><block type="biped_gesture"><field name="GESTURE">GESTURE_GREETING</field><next><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">2000</field></block></value><next><block type="biped_gesture"><field name="GESTURE">GESTURE_CHEER</field><next><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">2000</field></block></value><next><block type="biped_gesture"><field name="GESTURE">GESTURE_SURPRISE</field><next><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">2000</field></block></value></block></next></block></next></block></next></block></next></block></next></block></next></block></statement></block></xml>`
  },
  {
  ...
  },
  {
    ...
    category: 'iot',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="esp32_serial_begin"><field name="BAUD">115200</field><next><block type="wifi_connect"><field name="SSID">your_ssid</field><field name="PASSWORD">your_password</field><next><block type="modbus_init"><field name="RX">16</field><field name="TX">17</field><field name="DE_RE">4</field><field name="BAUD">9600</field><next><block type="controls_if"><mutation else="1"></mutation><value name="IF0"><block type="iot_cloud_connect"><field name="PROVIDER">azure_iot_hub</field><value name="CREDENTIALS"><shadow type="text"><field name="TEXT">{}</field></shadow></value></block></value><statement name="DO0"><block type="esp32_serial_println"><value name="VALUE"><shadow type="text"><field name="TEXT">IoT cloud connected</field></shadow></value></block></statement><statement name="ELSE"><block type="esp32_serial_println"><value name="VALUE"><shadow type="text"><field name="TEXT">IoT cloud connect FAILED</field></shadow></value></block></statement></block></next></block></next></block></next></block></statement></block><block type="arduino_loop" x="50" y="400"><statement name="LOOP"><block type="iot_cloud_publish"><value name="PAYLOAD"><block type="modbus_read_holding_register"><value name="ADDR"><shadow type="math_number"><field name="NUM">0</field></shadow></value></block></value><next><block type="esp32_delay"><value name="TIME"><shadow type="math_number"><field name="NUM">5000</field></shadow></value></block></next></block></statement></block></xml>`
  },
  {
  ...
  },
  {
    ...
    category: 'motor',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="stepper_init_4wire"><field name="IN1">14</field><field name="IN2">27</field><field name="IN3">26</field><field name="IN4">25</field></block></statement></block><block type="arduino_loop" x="50" y="200"><statement name="LOOP"><block type="stepper_rotate_blocking"><value name="ANGLE"><shadow type="math_number"><field name="NUM">90</field></shadow></value><next><block type="esp32_delay"><value name="TIME"><shadow type="math_number"><field name="NUM">1000</field></shadow></value><next><block type="stepper_rotate_blocking"><value name="ANGLE"><shadow type="math_number"><field name="NUM">-90</field></shadow></value><next><block type="esp32_delay"><value name="TIME"><shadow type="math_number"><field name="NUM">1000</field></shadow></value></block></next></block></next></block></next></block></statement></block></xml>`
  },
  {
  ...
  // BUG-085 (第132回): few-shot coverage 強化 D1 — WiFi + WS + DHT22 + LED + Servo
  // canonical sample。第131 までの wifi-controller-mix は MPU6050 ベースで、user の
  // 「DHT22 温度センサ」prompt に対し MPU6050 → DHT22 の暗黙置換を AI に要求していた。
  // 本 sample は user verbatim prompt を直接 cover する正解 reference (regex 経由で
  // 「WiFi controlled + DHT/temperature sensor」 prompt にこの sample を hit)。
  {
    id: 'wifi-dht22-controller',
    title: 'WiFi コントローラ + DHT22 温度配信 (Web UI + LED + Servo + 温度)',
    description: 'WebSocket サーバーで LED toggle / Servo slider をブラウザから制御 + DHT22 温度を Web UI に配信 (BUG-085: user verbatim prompt の正解 reference)。★ 必須: servo_write の ANGLE には websocket_server_received_value ブロックを必ず value 入力に接続 (固定値 hardcode 禁止)。★ 必須: websocket_server_received_value ブロックは on_message HANDLER 内のみに配置、arduino_setup / arduino_loop と sibling の top-level 配置は絶対禁止 (浮遊式 wsServerMessage; expression 生成原因)',
    category: 'iot',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="wifi_connect"><field name="SSID">your_ssid</field><field name="PASSWORD">your_password</field><next><block type="websocket_server_start"><field name="PORT">81</field><field name="PATH">/</field><next><block type="websocket_server_register"><field name="CHANNEL_ID">led</field><field name="LABEL">LED</field><field name="DATA_TYPE">bool</field><field name="MIN">0</field><field name="MAX">1</field><field name="READ">TRUE</field><field name="WRITE">TRUE</field><field name="NOTIFY">FALSE</field><next><block type="websocket_server_register"><field name="CHANNEL_ID">servo</field><field name="LABEL">Servo</field><field name="DATA_TYPE">uint8</field><field name="MIN">0</field><field name="MAX">180</field><field name="READ">TRUE</field><field name="WRITE">TRUE</field><field name="NOTIFY">FALSE</field><next><block type="websocket_server_register"><field name="CHANNEL_ID">temp</field><field name="LABEL">Temperature</field><field name="DATA_TYPE">float</field><field name="MIN">0</field><field name="MAX">100</field><field name="READ">TRUE</field><field name="WRITE">FALSE</field><field name="NOTIFY">TRUE</field><next><block type="esp32_pin_mode"><field name="PIN">2</field><field name="MODE">OUTPUT</field><next><block type="dht_init"><field name="PIN">4</field><field name="TYPE">DHT22</field><next><block type="websocket_server_on_message"><field name="CHANNEL_ID">led</field><statement name="HANDLER"><block type="controls_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="websocket_server_received_value"></block></value><value name="B"><block type="text"><field name="TEXT">1</field></block></value></block></value><statement name="DO0"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">HIGH</field></block></statement><next><block type="controls_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="websocket_server_received_value"></block></value><value name="B"><block type="text"><field name="TEXT">0</field></block></value></block></value><statement name="DO0"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">LOW</field></block></statement></block></next></block></statement><next><block type="websocket_server_on_message"><field name="CHANNEL_ID">servo</field><statement name="HANDLER"><block type="servo_write"><field name="PIN">13</field><value name="ANGLE"><block type="websocket_server_received_value"></block></value></block></statement></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block></statement></block><block type="arduino_loop" x="50" y="500"><statement name="LOOP"><block type="websocket_server_send"><field name="CHANNEL_ID">temp</field><value name="VALUE"><block type="dht_temperature"></block></value><next><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">1000</field></block></value></block></next></block></statement></block></xml>`
  },
  // BUG-085 (第132回): few-shot coverage 強化 D2 — HA 複数 entity 双方向 (Switch +
  // Number + Sensor)。ha-led-control は単一 entity 例、ha-multi-sensor は read-only。
  // 本 sample は HA callback cluster (ha_switch_on_command + ha_number_on_command)
  // を 1 device で示し、AI が「HA + 複数制御 entity」prompt で callback 配置 + 各
  // entity に対応する on_command HANDLER + ha_loop の 3 点 anti-pattern (callback
  // nesting / arduino_loop 外配置漏れ / ha_loop 不在) を回避する reference。
  {
    id: 'ha-multi-control',
    title: 'HA 複数 entity 制御 (Switch + Number Slider + Sensor)',
    description: 'Home Assistant から Switch ON/OFF で LED 制御 + Number Slider で servo 角度制御 + DHT22 温度を sensor として報告 (HA callback cluster の正解 reference、BUG-085)',
    category: 'iot',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="esp32_serial_begin"><field name="BAUD">115200</field><next><block type="esp32_pin_mode"><field name="PIN">2</field><field name="MODE">OUTPUT</field><next><block type="dht_init"><field name="PIN">4</field><field name="TYPE">DHT22</field><next><block type="ha_device_init"><field name="SSID">your_ssid</field><field name="WIFI_PASS">your_password</field><field name="BROKER">192.168.1.100</field><field name="PORT">1883</field><field name="DEVICE_NAME">マルチ制御デバイス</field><field name="DEVICE_ID">multi_control</field><field name="MANUFACTURER">Digi Co LLC</field><field name="MODEL">ESP32</field><field name="SOFTWARE_VERSION">1.0.0</field><field name="AUTO_UNIQUE_ID">TRUE</field><field name="AVAILABILITY">TRUE</field><field name="VIA_DEVICE"></field><next><block type="ha_switch_create"><field name="SWITCH_ID">relay</field><field name="NAME">LED Relay</field><field name="ICON">mdi:power</field><next><block type="ha_number_create"><field name="NUMBER_ID">servo_angle</field><field name="NAME">Servo Angle</field><value name="MIN"><block type="math_number"><field name="NUM">0</field></block></value><value name="MAX"><block type="math_number"><field name="NUM">180</field></block></value><value name="STEP"><block type="math_number"><field name="NUM">1</field></block></value><field name="UNIT">°</field><field name="MODE">slider</field><next><block type="ha_sensor_create"><field name="SENSOR_ID">temperature</field><field name="NAME">温度</field><field name="DEVICE_CLASS">temperature</field><field name="UNIT">°C</field><field name="ICON">mdi:thermometer</field></block></next></block></next></block></next></block></next></block></next></block></next></block></statement></block><block type="arduino_loop" x="50" y="600"><statement name="LOOP"><block type="ha_report_interval"><value name="INTERVAL"><block type="math_number"><field name="NUM">30</field></block></value><statement name="CALLBACK"><block type="ha_sensor_update"><field name="SENSOR_ID">temperature</field><value name="VALUE"><block type="dht_temperature"></block></value></block></statement><next><block type="ha_loop"></block></next></block></statement></block><block type="ha_switch_on_command" x="450" y="50"><field name="SWITCH_ID">relay</field><statement name="ON_CALLBACK"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">HIGH</field></block></statement><statement name="OFF_CALLBACK"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">LOW</field></block></statement></block><block type="ha_number_on_command" x="450" y="300"><field name="NUMBER_ID">servo_angle</field><statement name="CALLBACK"><block type="servo_write"><field name="PIN">13</field><value name="ANGLE"><block type="ha_number_value"></block></value></block></statement></block></xml>`
  },
  // BUG-085 (第132回): few-shot coverage 強化 D3 — ESP-NOW peer 受信 → アクチュエータ
  // 制御。既存 espnow-mesh-receiver は Serial 出力のみ (read-only)。本 sample は
  // espnow_on_receive HANDLER 内で espnow_received_data + controls_if 分岐 +
  // esp32_digital_write で LED 制御の正解 pattern を示す = AI が「ESP-NOW + LED 制御」
  // prompt で variables_get 'data' / 'message' fake variable を作る anti-pattern を回避。
  {
    id: 'espnow-peer-control',
    title: 'ESP-NOW ピア受信 → LED 制御 (アクチュエータ駆動)',
    description: 'ESP-NOW で他デバイスから "LED_ON" / "LED_OFF" メッセージを受信して LED を制御 (espnow_received_data + controls_if 分岐パターン、BUG-085)',
    category: 'iot',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="esp32_serial_begin"><field name="BAUD">115200</field><next><block type="esp32_pin_mode"><field name="PIN">2</field><field name="MODE">OUTPUT</field><next><block type="espnow_init"></block></next></block></next></block></statement></block><block type="arduino_loop" x="50" y="320"><statement name="LOOP"><block type="espnow_on_receive"><statement name="HANDLER"><block type="controls_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="espnow_received_data"></block></value><value name="B"><block type="text"><field name="TEXT">LED_ON</field></block></value></block></value><statement name="DO0"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">HIGH</field></block></statement><next><block type="controls_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="espnow_received_data"></block></value><value name="B"><block type="text"><field name="TEXT">LED_OFF</field></block></value></block></value><statement name="DO0"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">LOW</field></block></statement></block></next></block></statement></block></statement></block></xml>`
  },
  // BUG-086 Session 133 C5: 2-channel WiFi controller canonical sample
  // (LED + servo only, no DHT22). BUG-086 root cause was that wifi-dht22-
  // controller (3-channel) was the closest match for "WiFi controlled LED +
  // servo" user prompts that don't mention temperature, causing AI to
  // overgeneralize the 3-channel pattern and drop the servo on_message
  // handler. This new sample provides the clean 2-channel reference.
  {
    id: 'wifi-led-servo-controller',
    title: 'WiFi コントローラ + LED + Servo (2-channel、温度センサなし)',
    description: 'WebSocket サーバーで LED toggle / Servo slider をブラウザから制御 (BUG-086: 2-channel canonical reference)。★ 必須: 各 WRITE=TRUE register block (led / servo) に対応する websocket_server_on_message handler を同 CHANNEL_ID で必ず生成。★ 必須: servo_write の ANGLE には websocket_server_received_value ブロックを value 入力に接続 (固定値 hardcode 禁止)',
    category: 'iot',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="wifi_connect"><field name="SSID">your_ssid</field><field name="PASSWORD">your_password</field><next><block type="websocket_server_start"><field name="PORT">81</field><field name="PATH">/</field><next><block type="websocket_server_register"><field name="CHANNEL_ID">led</field><field name="LABEL">LED</field><field name="DATA_TYPE">bool</field><field name="MIN">0</field><field name="MAX">1</field><field name="READ">TRUE</field><field name="WRITE">TRUE</field><field name="NOTIFY">FALSE</field><next><block type="websocket_server_register"><field name="CHANNEL_ID">servo</field><field name="LABEL">Servo</field><field name="DATA_TYPE">uint8</field><field name="MIN">0</field><field name="MAX">180</field><field name="READ">TRUE</field><field name="WRITE">TRUE</field><field name="NOTIFY">FALSE</field><next><block type="esp32_pin_mode"><field name="PIN">2</field><field name="MODE">OUTPUT</field><next><block type="websocket_server_on_message"><field name="CHANNEL_ID">led</field><statement name="HANDLER"><block type="controls_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="websocket_server_received_value"></block></value><value name="B"><block type="text"><field name="TEXT">1</field></block></value></block></value><statement name="DO0"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">HIGH</field></block></statement><next><block type="controls_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="websocket_server_received_value"></block></value><value name="B"><block type="text"><field name="TEXT">0</field></block></value></block></value><statement name="DO0"><block type="esp32_digital_write"><field name="PIN">2</field><field name="VALUE">LOW</field></block></statement></block></next></block></statement><next><block type="websocket_server_on_message"><field name="CHANNEL_ID">servo</field><statement name="HANDLER"><block type="servo_write"><field name="PIN">13</field><value name="ANGLE"><block type="websocket_server_received_value"></block></value></block></statement></block></next></block></next></block></next></block></next></block></next></block></next></block></statement></block><block type="arduino_loop" x="50" y="500"><statement name="LOOP"><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">100</field></block></value></block></statement></block></xml>`
  },
  {
  ...
  },
  {
    ...
    title: 'Biped 歩行 + MQTT 並行',
    description: 'biped_walk_async でバックグラウンド歩行しつつ MQTT で温度を publish (D-new-4 (B) IoT 共存主軸 demo、blocking 版なら loop 停止するが async + wait_until_idle で並行動作)',
    category: 'robots',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="mqtt_setup"><value name="PORT"><block type="math_number"><field name="NUM">1883</field></block></value><field name="SSID">your_ssid</field><field name="WIFI_PASS">your_password</field><field name="BROKER">192.168.1.100</field><field name="CLIENT_ID">biped_iot</field><next><block type="biped_init"><field name="PIN_LL">27</field><field name="PIN_RL">15</field><field name="PIN_LF">14</field><field name="PIN_RF">13</field><field name="PIN_BUZZER">25</field><next><block type="dht_init"><field name="PIN">4</field><field name="TYPE">DHT22</field><next><block type="mqtt_connect"><field name="USERNAME"></field><field name="PASSWORD"></field></block></next></block></next></block></next></block></statement></block><block type="arduino_loop" x="50" y="250"><statement name="LOOP"><block type="biped_walk_async"><value name="STEPS"><block type="math_number"><field name="NUM">4</field></block></value><field name="DIRECTION">1</field><field name="SPEED">normal</field><next><block type="mqtt_loop"><next><block type="mqtt_publish"><field name="TOPIC">robot/biped/temperature</field><field name="RETAIN">FALSE</field><value name="MESSAGE"><block type="text_join"><value name="ADD0"><block type="text"><field name="TEXT">temp=</field></block></value><value name="ADD1"><block type="dht_temperature"></block></value></block></value><next><block type="biped_wait_until_idle"><next><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">3000</field></block></value></block></next></block></next></block></next></block></next></block></statement></block></xml>`
  },
  {
    id: 'stepper-hw-precise',
    title: 'Stepper HW 高精度位置制御',
    description: 'FastAccelStepper (HW peripheral RMT/MCPWM) で高速・高精度位置制御 (D9 demo、目標 200 kHz、polling 不要、AccelStepper 比 step jitter 大幅低減)',
    category: 'motor',
    language: 'arduino',
    blocklyXml: `<xml xmlns="https://developers.google.com/blockly/xml"><block type="arduino_setup" x="50" y="50"><statement name="SETUP"><block type="stepper_init_hw"><field name="STEP">25</field><field name="DIR">26</field><field name="EN">27</field><next><block type="stepper_set_speed"><value name="SPEED"><block type="math_number"><field name="NUM">10000</field></block></value></block></next></block></statement></block><block type="arduino_loop" x="50" y="200"><statement name="LOOP"><block type="stepper_rotate_blocking"><value name="ANGLE"><block type="math_number"><field name="NUM">360</field></block></value><next><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">500</field></block></value><next><block type="stepper_rotate_blocking"><value name="ANGLE"><block type="math_number"><field name="NUM">-360</field></block></value><next><block type="esp32_delay"><value name="TIME"><block type="math_number"><field name="NUM">500</field></block></value></block></next></block></next></block></next></block></statement></block></xml>`
  }
];
