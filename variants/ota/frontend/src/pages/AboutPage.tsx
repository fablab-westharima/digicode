...
function UniqueFeature({ title, description, tag, pricing = 'free' }: { title: string; description: string; tag: string; pricing?: 'free' | 'pro' }) {
  return (
...
function PlanRow({ feature, guest, free, pro, note }: { feature: string; guest: boolean; free: boolean; pro: boolean; note?: string }) {
...
function BoardCategory({ title, boards }: { title: string; boards: string[] }) {
  return (
    <div className="bg-[#161B22] border border-[#30363D] rounded-lg p-5">
