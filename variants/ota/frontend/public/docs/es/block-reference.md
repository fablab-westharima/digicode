...
| **BLE Al Recibir** | Maneja datos recibidos (use el bloque BLE Recibido dentro del manejador) | Manejador |
| **BLE Recibido** | Obtiene el texto recibido (uso dentro del manejador) | → String |
