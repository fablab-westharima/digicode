...
#### 🤖 イメージ取得・起動で困ったら AI に聞く

下のプロンプトをコピーして Gemini / ChatGPT 等の AI アシスタントに貼り付けてください。

```
Docker Desktop の最新 UI で、DockerHub からイメージを検索して Pull し、
コンテナを起動する手順を教えてください。
...
#### 🤖 起動確認・トラブルで困ったら AI に聞く

```
Docker Desktop でコンテナが正常に起動しているか確認する方法を教えてください。
最新の Docker Desktop の画面構成をまず調べてから回答してください。
...
### 🤖 Docker Desktop インストールで困ったら AI に聞く

下のプロンプトをコピーして Gemini / ChatGPT 等の AI アシスタントに貼り付けてください。`[Windows/Mac]` は自分の OS に書き換えてください。

```
最新の Docker Desktop を [Windows/Mac] にインストールする手順を、
最新の公式サイト情報を調べた上で、初心者向けに 1 ステップずつ教えてください。
```
